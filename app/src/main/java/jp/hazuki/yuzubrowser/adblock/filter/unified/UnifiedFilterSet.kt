...
import jp.hazuki.yuzubrowser.adblock.filter.abp.badfilterPrefixes
...
class UnifiedFilterSet(
    ...
    /** Scriptoria change: "+js(...)" rules, carrying the call text in place of a selector. */
    val scriptletList: List<ElementFilter>,
